        ...
        if (localStorage.getItem("role") == "Admin") {
            return (
                <form onSubmit={this.handleSubmit} >
                    <div className="container-fluid">
                        <div className="py-2 text-white mb-2" style={{ backgroundColor: '#0000b3' }}> <h5 className="font-weight-bold ml-3">Edit Question:&nbsp;<span className="font-weight-bold small">{this.state.question.question} </span> </h5></div>
                        <div className="mt-4">
                            ...
                            <div className="form-group row ml-1">
                                <button type="button" className=" ml-2 py-1  btn btn-success" id="inputQue" onClick={this.addAnswer} ><div ><h6 className="font-weight-bold ">ADD</h6><h6 className="font-weight-bold">ANSWER</h6></div> </button>
                            </div>
                            <div className="row">
                                <label for="inputQue" className="col-xl-2 col-md-4"></label>
                                <div className="col-xl-8 col-md-4 col-sm-6 ml-2 ">
                                    <button type="submit" value="save" className="py-2 w  ml-2  btn-primary font-weight-bold">SAVE</button>
                                    <button type="button" className="py-2 ml-2 btn-dark font-weight-bold" id={"cancel"} onClick={this.cancelOrDelete}  >CANCEL</button>
                                    <button type="button" className="py-2 ml-2 btn-danger font-weight-bold" id={"delete"} onClick={this.cancelOrDelete}>DELETE</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            return (
                <div className="container">
                    <div classNameName="alert alert-danger  alert-dismissible  col-lg-9 col-md-9 col-sm-12 ">
