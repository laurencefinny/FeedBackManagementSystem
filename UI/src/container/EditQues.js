            ...
            return (
                <form onSubmit={this.handleSubmit} >
                    <div class="container-fluid">
                        <div class="py-2 text-white mb-2" style={{ backgroundColor: '#0000b3' }}> <h5 class="font-weight-bold ml-3">Edit Question:&nbsp;<span class="font-weight-bold small">{this.state.question.question} </span> </h5></div>
                        <div class="mt-4">
                            ...
                            <div class="form-group row ml-1">
                                <button type="button" class=" ml-2 py-1  btn btn-success" id="inputQue" onClick={this.addAnswer} ><div ><h6 class="font-weight-bold ">ADD</h6><h6 class="font-weight-bold">ANSWER</h6></div> </button>
                            </div>
                            <div class="row">
                                <label for="inputQue" class="col-xl-2 col-md-4"></label>
                                <div class="col-xl-8 col-md-4 col-sm-6 ml-2 ">
                                    <button type="submit" value="save" class="py-2 w  ml-2  btn-primary font-weight-bold">SAVE</button>
                                    <button type="button" class="py-2 ml-2 btn-dark font-weight-bold" id={"cancel"} onClick={this.cancelOrDelete}  >CANCEL</button>
                                    <button type="button" class="py-2 ml-2 btn-danger font-weight-bold" id={"delete"} onClick={this.cancelOrDelete}>DELETE</button>
                                </div>
                            </div>
                        </div>
                    </div>
